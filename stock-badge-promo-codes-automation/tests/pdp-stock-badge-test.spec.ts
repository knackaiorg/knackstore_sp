...
import { PdpStockBadgePromoCodesPage as PdpStockBadgePage } from '../pages/pdp-stock-badge-promo-codes-page';
...
test.describe('PDP Low Stock Badge', () => {
  ...
  test('TC02: Badge has warning class (bg-warning) when stock is low 4–9 @sanity @regression', async ({ page }) => {
  ...
  test('TC03: Badge has danger class (bg-danger) when stock is critical 1–3 @sanity @regression', async ({ page }) => {
