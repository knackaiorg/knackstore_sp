...
import { Address, Cart, SavedAddress,DeliveryOption } from '../../models';
...
export class CheckoutComponent implements OnInit {
  ...
  nextStep() {
    ...
    const hasSelectedSavedAddress = this.savedAddresses.some(a => a.id === this.selectedAddressId);
    if (!hasSelectedSavedAddress) return;
